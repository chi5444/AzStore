...
const TRANSLATIONS = {
  fr: {
    ...
    whatsappDiscordLabel: "Numéro WhatsApp ou pseudo Discord",
  ...
  en: {
    ...
    whatsappDiscordLabel: "WhatsApp number or Discord username",
  ...
  ar: {
    ...
    whatsappDiscordLabel: "رقم واتساب أو اسم مستخدم ديسكورد",
